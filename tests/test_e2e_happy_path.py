...
def test_full_workflow_quiz_creation_to_graded_reviewed_result(
    ...
    # 1. create quiz + upload questions (.xlsx) in one step — R1.1/R1.2
    ...
    # 3. download both PDFs for every version (R3.1/R3.4)
    for v in versions:
    ...
    # 5. scan an all-correct submission through the real upload view
    ...
    # 6. the review UI shows it, unflagged, all correct
    ...
    # 8. results list + CSV export both show it
